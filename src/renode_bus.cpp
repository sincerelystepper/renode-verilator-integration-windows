...
extern "C" void handleMainMessage(void* ptr);
extern "C" void handleSenderMessage(void* ptr);
extern "C" void receive(void* ptr);

extern "C" void HandleMainMessage(void* ptr) { handleMainMessage(ptr); }
extern "C" void HandleSenderMessage(void* ptr) { handleSenderMessage(ptr); }
extern "C" void Receive(void* ptr) { receive(ptr); }
